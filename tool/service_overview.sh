...
function service_overview(){
    ...
    if [ ! -f "${METEORITE_DIR}/tmp/install_openresty.lock" ] && [ ! -f "${METEORITE_DIR}/tmp/install_mariadb.lock" ] && [ ! -f "${METEORITE_DIR}/tmp/install_php.lock" ] && [ ! -f "${METEORITE_DIR}/tmp/install_redis.lock" ] && [ ! -f "${METEORITE_DIR}/tmp/install_memcached.lock" ] && [ ! -f "${METEORITE_DIR}/tmp/install_imagemagick.lock" ];then
